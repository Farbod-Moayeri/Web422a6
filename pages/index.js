...
export default function Home() {
  return (
    <>
      <Row>
        <Col><Image fluid alt="Metropolitan Museum of Art" className="" src="https://upload.wikimedia.org/wikipedia/commons/3/30/Metropolitan_Museum_of_Art_%28The_Met%29_-_Central_Park%2C_NYC.jpg" rounded /></Col>
      </Row>
      <br/>
      <Row>
        <Col>
